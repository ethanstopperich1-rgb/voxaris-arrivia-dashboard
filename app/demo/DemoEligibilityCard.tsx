...
export function DemoEligibilityCard({ deedyNumber }: { deedyNumber: string }) {
  ...
  if (choice === "no") {
    return (
      <div className="flex flex-col items-center px-6 py-10 text-center">
        <p className="text-lg font-bold uppercase tracking-wide text-[#0d9488]">
        ...
        <button
          ...
          className="mt-8 inline-flex items-center justify-center gap-2 rounded-md border-2 border-[#0d9488] px-6 py-3 text-sm font-semibold uppercase tracking-wider text-[#0d9488] transition hover:bg-[#0d9488] hover:text-white"
        >
  ...
  return (
    <div className="flex flex-col px-6 py-8">
      {/* Greeting */}
      <p className="text-center text-lg font-bold uppercase tracking-wide text-[#0d9488]">
      ...
      <div className="mt-6 border-t border-neutral-200 pt-6">
        ...
        <label className="mt-5 flex cursor-pointer items-start gap-2 text-xs leading-snug text-neutral-700">
          <input
            ...
            className="mt-0.5 h-4 w-4 cursor-pointer rounded border-neutral-400 accent-[#0d9488]"
          />
          <span>
        ...
        <a
          ...
          className={cn(
            ...
            canSubmit
              ? "bg-[#0d9488] text-white hover:bg-[#0a7e74]"
