...
async function dispatchOne(
  ...
  const md: Record<string, unknown> = {
    ...
    queue_id: row.id,
    // No AMD flag — Andie detects voicemail herself via the
    // leave_voicemail tool (LLM-driven classification, matching
    // the official LiveKit outbound-caller-python pattern).
    ...(row.member_name
